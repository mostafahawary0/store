...
@endif
        ...
        <h3 class="h4 mb-0" style="color:#8A8D93;">Edit section</h3> <br>

    <div class="mb-3">
    <label class="form-label" style="color:#fff;">Section in Arabic</label>
     <input name="titlear" value="{{$sections->sectionAR}}" class="form-control @error('titlear') is-invalid @enderror"  type="text">
    @error('titlear')
    ...
    <input  name="titleen" value="{{$sections->sectionEN}}" class="form-control @error('titleen') is-invalid @enderror"  type="text">
        @error('titleen')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror 
    </div>
